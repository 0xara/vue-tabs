(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('js-helpers/dist/hash'), require('js-helpers/dist/array/forEach')) :
    typeof define === 'function' && define.amd ? define(['exports', 'js-helpers/dist/hash', 'js-helpers/dist/array/forEach'], factory) :
    (global = global || self, factory(global.VueTabs = {}, global.hash, global.forEach));
}(this, (function (exports, hash, forEach) { 'use strict';
    ...
    var script = {
        ...
        created: function created() {
            var hash$1 = hash.getHash();
            hash$1 = this.isEncoded(hash$1) ? hash$1 : encodeURIComponent(hash$1);
            hash.pushHash(hash$1);
        },
        ...
        methods: {
            setClickHandlers: function setClickHandlers() {
                ...
                forEach.forEach($links, function (key, $elm) {
            ...
            handleHash: function handleHash() {
                ...
                var hash$1 = decodeURIComponent(hash.getHash());

                hash$1 = hash$1.split('/');

                forEach.forEach(hash$1, function (key, v) {
                    ...
                    forEach.forEach(self.$el.querySelectorAll('.tab'), function (k, $e) {
            ...
            pushHash: function pushHash(link) {
                var _this2 = this;
                ...
                hash.pushHash(encodeURIComponent(newHash.join('/')));
            },
